...
C                         PERROR2, PERVEC, PJAC, PMULT, PRBNDX,      
C                         PSTOP, QSRT, DAXPY, SBELM, SCAL, DCOPY,  
...
C       
  340 IDGTS = IPARM(12)     
      ...
      CALL PERROR2 (N,IA,JA,A,RHS,U,WKSP,DIGIT1,DIGIT2,IDGTS)
C       
...
C                        PERMAT, PERROR2, PERVEC, PJAC, PMULT, PRBNDX, 
C                        PSTOP, PVTBV, QSRT, DAXPY, SBELM, SCAL,   
...
C       
         IF (HALT) GO TO 270
        IDIVIDE=LOOP/25
        IREMAINDER=LOOP-IDIVIDE*25
        IF(IREMAINDER.EQ.0)THEN
         OPEN(98,FILE='solution',FORM='UNFORMATTED')
C         WRITE(98)N,(A(NINI),NINI=1,N),(U(NINI),NINI=1,N)
         WRITE(98)N
         DO NINI=1,N
          WRITE(98)A(NINI),U(NINI)
         ENDDO
         CLOSE(98)
        ENDIF
  240 CONTINUE    
...
C                        TIMER, ITSOR, IVFILL, PERMAT, PERROR2,      
C                        PERVEC, PFSOR1, PMULT, PRBNDX, PSTOP, QSRT, 
...
C                         PARCON, PBETA, PBSOR, PERMAT, PERROR2,     
C                         PERVEC, PFSOR, PJAC, PMULT, PRBNDX, PSTOP, PVT
C                         QSRT, SBELM, SCAL, DCOPY, DDOT, SUM3,    
...
C                         OMGSTR, PARSI, PBETA, PERMAT, PERROR2,     
C                         PERVEC, PFSOR, PMULT, PRBNDX, PSSOR1,     
C                         PSTOP, PVTBV, QSRT, SBELM, SCAL, DCOPY,  
...
C                         PERROR2, PERVEC, PMULT, PRBNDX, PRSBLK,    
C                         PRSRED, PSTOP, QSRT, SBELM, SCAL, DCOPY, 
...
C                         PARSI, PERMAT, PERROR2, PERVEC, PMULT,     
C                         PRBNDX, PRSBLK, PRSRED, PSTOP, QSRT,     
...
C                   IER = 303  ERROR RETURN FROM QSRT IN 
...
C     QSRT WHICH PERFORMS A QUICK SORT TO PLACE THE ENTRIES IN     
...
C       
         IBGN = IA(I)       
         CALL QSRT (K,JA(IBGN),A(IBGN),IER)    
         IF (IER.NE.0) GO TO 130      
C       
   80 CONTINUE    
C       
...
C       
  150 CONTINUE    
      ...
      RETURN      
      END 
      SUBROUTINE PERROR2 (NN,IA,JA,A,RHS,U,W,DIGTT1,DIGTT2,IDGTTS)   
C       
C     PERROR2 COMPUTES THE RESIDUAL, R = RHS - A*U.  THE USER
...
C       
      RETURN      
      END 
      SUBROUTINE QSRT (NN,KEY,DATA,ERROR)      
C       
C     ==================================================================
C       
C     Q U I C K S O R T     
...
C       
c      write(6,*)'n,nz,ii,jj = ',n,nz,ii,jj
      I = II      
      J = JJ      
      VAL = VALL  
      LEVEL = LEVELL
